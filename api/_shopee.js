// /api/_shopee.js
// Helper reutilizável pra fazer qualquer chamada à Shopee Affiliate Open API.
// Os outros arquivos /api/*.js importam essa função em vez de repetir a lógica de assinatura.
